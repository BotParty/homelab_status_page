(function(f,s){typeof exports=="object"&&typeof module!="undefined"?s(exports):typeof define=="function"&&define.amd?define(["exports"],s):(f=typeof globalThis!="undefined"?globalThis:f||self,s(f.MyLib={}))})(this,function(f){"use strict";const s=(e,r,n)=>{let t={size:r.byteLength+3&-4,usage:n,mappedAtCreation:!0},u=e.createBuffer(t);return r[5]=Date.now(),(r instanceof Uint16Array?new Uint16Array(u.getMappedRange()):new Float32Array(u.getMappedRange())).set(r),u.unmap(),u};function v(e){if(typeof e.width!="number")throw new Error("bad data!!")}const x=function(e,r){e.addEventListener("mousemove",n=>{let t=n.pageX,u=n.pageY;r.mouseX=t/n.target.clientWidth,r.mouseY=u/n.target.clientHeight})};function b(e=innerWidth,r=innerHeight){let n=devicePixelRatio;var t=document.createElement("canvas");return t.width=n*e,t.height=n*r,t.style.width=e+"px",document.body.appendChild(t),t}var p={createBuffer:s,createCanvas:b,validateData:v,addMouseEvents:x},h=`// let size = 4.0;
