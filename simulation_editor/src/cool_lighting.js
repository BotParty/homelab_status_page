...
function init() {
    ...
    const roughnessUniform = uniform( 0.0 ); // Set roughness to 0 for maximum shininess
    const metalnessUniform = uniform( 1.0 ); // Set metalness to 1 for metallic surface
    ...
    defaultMat.metalnessNode = metalnessUniform;
    ...
    boxProjectedMat.metalnessNode = metalnessUniform;
