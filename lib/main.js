...
const recordRenderPass = async function (state) {
  ...
  let cubeVertexArray = new Float32Array(state.options.attributes.position.flat());
...
//Texture constructor
//Buffer constructor - takes an object of options and has a list of methods 
//copy regl